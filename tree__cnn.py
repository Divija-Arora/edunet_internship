...
Original file is located at
    https://colab.research.google.com/drive/1NrjIGVklb5QgY21qeTm1DpdBrrny80Y_
"""
...
zip_path = "/content/drive/My Drive/archive (2).zip"  # <-- update this if file name is different
